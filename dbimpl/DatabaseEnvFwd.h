...
using TestDatabasePreparedStatement = PreparedStatement<TestDatabaseConnection>;
...
using TestDatabaseTransaction = SQLTransaction<TestDatabaseConnection>;
...
using TestDatabaseQueryHolder = SQLQueryHolder<TestDatabaseConnection>;
